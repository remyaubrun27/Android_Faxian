 ...
 */
public class Linzi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.frag_linzi, container, false);
        //buttons
        ...
        //TEMPORIALLY COMMENT: FOR DEMO PURPOSES ONLY
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                enemyArchers = dataSnapshot.child("Cities").child("Linzi").child("troopCount").child("Archers").getValue().toString();
                enemySwordsmen = dataSnapshot.child("Cities").child("Linzi").child("troopCount").child("Swordsmen").getValue().toString();
                enemySpearmen = dataSnapshot.child("Cities").child("Linzi").child("troopCount").child("Spearmen").getValue().toString();
                enemyCavalry = dataSnapshot.child("Cities").child("Linzi").child("troopCount").child("Cavalry").getValue().toString();
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                attackButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        cityPower = dataSnapshot.child("Cities").child("Linzi").child("cityPower").getValue().toString();
