 ...
 */
public class Changan extends Fragment {
    ...
    private Integer battleWon,battleFought;
    private String userPower, cityPower;
    private Integer archerPower,swordsmenPower,spearmenPower,cavalryPower;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.frag_changan, container, false);
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                enemyArchers = dataSnapshot.child("Cities").child("Chang'an").child("troopCount").child("Archers").getValue().toString();
                enemySwordsmen = dataSnapshot.child("Cities").child("Chang'an").child("troopCount").child("Swordsmen").getValue().toString();
                enemySpearmen = dataSnapshot.child("Cities").child("Chang'an").child("troopCount").child("Spearmen").getValue().toString();
                enemyCavalry = dataSnapshot.child("Cities").child("Chang'an").child("troopCount").child("Cavalry").getValue().toString();
                ...
                oppArchers.setText("Archers");
                userArchers.setText("Archers");
                oppSwordsmen.setText("Swordsmen");
                userSwordsmen.setText("Swordsmen");
                oppSpearmen.setText("Spearmen");
                userSpearmen.setText("Spearmen");
                oppCavalry.setText("Cavalry");
                userCavalry.setText("Cavalry");
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                attackButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        cityPower = dataSnapshot.child("Cities").child("Changan").child("cityPower").getValue().toString();
