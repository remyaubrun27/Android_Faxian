 ...
 */
public class Luoyang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.frag_luoyang, container, false);
        //buttons
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                enemyArchers = dataSnapshot.child("Cities").child("Luoyang").child("troopCount").child("Archers").getValue().toString();
                enemySwordsmen = dataSnapshot.child("Cities").child("Luoyang").child("troopCount").child("Swordsmen").getValue().toString();
                enemySpearmen = dataSnapshot.child("Cities").child("Luoyang").child("troopCount").child("Spearmen").getValue().toString();
                enemyCavalry = dataSnapshot.child("Cities").child("Luoyang").child("troopCount").child("Cavalry").getValue().toString();
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                attackButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        cityPower = dataSnapshot.child("Cities").child("Luoyang").child("cityPower").getValue().toString();
